using Machon_Connor_HW3.DAL;
using Microsoft.AspNetCore.Builder;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.DependencyInjection;

//TODO: Make this namespace match your project - be sure to remove the []
namespace Machon_Connor_HW3
{ 
    public class Startup
{
    public void ConfigureServices(IServiceCollection services)
    {
            var connectionString = "Server=tcp:fa20machonconnorhw3.database.windows.net,1433;Initial Catalog=fa20MachonConnorhw3;Persist Security Info=False;User ID=connor;Password=ABC123!!!;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
